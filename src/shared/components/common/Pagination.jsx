...
const PaginationComponent = ({
    ...
    const siblingsStart = Math.max(
        Math.min(page - siblingsCount, totalPages - boundaryCount - siblingsCount * 2 - 1),
        boundaryCount + 2,
    );

    const siblingsEnd = Math.min(
        Math.max(page + siblingsCount, boundaryCount + siblingsCount * 2 + 2),
                    ...
                    <PaginationContent className="items-center">
                        ...
                        <PaginationItem className="hidden sm:block">
                            <form onSubmit={handleJumpToPage} className="flex items-center">
                                ...
                                />
                                <Button type="submit" size="sm" variant="ghost" className="h-8 px-1.5 ml-0.5">
                                    Go
                                </Button>
                            </form>
                        </PaginationItem>
