...
const PaginationLink = ({ className, isActive, children, disabled, ...props }) => (
    <Button
...
const PaginationEllipsis = ({ className, ...props }) => (
    <div aria-hidden className={cn("flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center", className)} {...props}>
