            ...
            switch (type) {
                case "conversions":
                    ...
                    if (response && response.data) {
                        ...
                        setSuccessMessage(
                            `ETL completed: ${totalProcessed} processed, ${added} added, ${updated} updated, ${skipped} skipped`,
                        );
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-sm">
                                            {syncStatus ? formatDate(syncStatus.customers) : "Loading..."}
                                        </span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm font-medium">Team Members</span>
                                        <span className="text-sm">
                                            {syncStatus ? formatDate(syncStatus.teams) : "Loading..."}
                                        </span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm font-medium">Booking Events</span>
                                        <span className="text-sm">
                                            {syncStatus ? formatDate(syncStatus.bookingEvents) : "Loading..."}
                                        </span>
                                    </div>
                                </div>
                            </CardContent>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-sm">
                                            {etlStatus ? formatDate(etlStatus.conversions) : "Loading..."}
                                        </span>
                                    </div>
                                </div>
                            </CardContent>
