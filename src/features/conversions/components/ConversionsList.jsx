                                  ...
                                  <li key={index} className='relative pl-8'>
                                    ...
                                    <div className='flex flex-col md:flex-row md:items-center text-sm'>
                                      ...
                                      <div className='flex items-center flex-wrap gap-2 mt-1 md:mt-0 overflow-hidden'>
                                        ...
                                        <span className='px-2 py-1 text-xs rounded-md bg-muted max-w-md truncate'>
                                          {event.pageUrl}
                                        </span>

                                        {event.fbclid && event.eventName !== 'create_booking' && (
                                          <span className='px-2 py-1 text-xs rounded-md bg-blue-100 text-blue-800 border border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800'>
                                            📱 Click ID
                                          </span>
                                        )}

                                        {event.utm && event.eventName !== 'create_booking' && (
                                          <span className='px-2 py-1 text-xs rounded-md bg-green-100 text-green-800 border border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800'>
                                            📊 UTM Parameters
                                          </span>
                                        )}
