                                                        ...
                                                        <td className="p-4 align-middle font-medium">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                {conversion.bookingId &&
                                                                    !conversion.bookingId.startsWith("booking-") && (
                                                                        <button
                                                                            onClick={(e) =>
                                                                                copyToClipboard(conversion.bookingId, e)
                                                                            }
                                                        ...
                                                        <td className="p-4 align-middle">
                                                            {conversion.bookingDate ? (
                                                                <span className="text-sm">
                                                                    {dayjs(conversion.bookingDate).format(
                                                                        "MMM D, YYYY",
                                                                    )}
                                                                </span>
                                                            ) : (
                                                                ...
                                                                <div className="mb-3">
                                                                    ...
                                                                    {conversion.isNewCustomer !== null && (
                                                                        <p className="text-xs mt-1">
                                                                            Customer Status:{" "}
                                                                            <span
                                                                                className={`font-medium ${conversion.isNewCustomer ? "text-green-600 dark:text-green-400" : "text-blue-600 dark:text-blue-400"}`}
                                                                            >
                                                                                {conversion.isNewCustomer
                                                                                    ? "New Customer"
                                                                                    : "Returning Customer"}
                                                                    ...
                                                                    <div className="text-xs font-medium mt-2 space-y-1">
                                                                        <div>
                                                                            ...
                                                                            {conversion.details?.score?.current
                                                                                ?.calculation ||
                                                                                conversion.details?.score
                                                                                    ?.scoreCalculation ||
                                                                                "N/A"}
                                                                        </div>
                                                                            ...
                                                                            conversion.details.score.previousSequences
                                                                                ...
                                                                                <div className="mt-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                                                                                    <div className="font-bold text-blue-800 dark:text-blue-300 text-xs mb-1">
                                                                                        Previous Conversions for this
                                                                                        Customer:
                                                                                    </div>
                                                                                    <div className="space-y-1">
                                                                                        {conversion.details.score.previousSequences.map(
                                                                                            (prev, idx) => (
                                                                                                <div
                                                                                                    key={idx}
                                                                ...
                                                                <div className="mt-4 pt-3 border-t">
                                                                    <div className="flex flex-col sm:flex-row sm:justify-between">
                                                                        ...
                                                                        <div className="mt-2 sm:mt-0">
                                                                            ...
                                                                            {(() => {
                                                                                const campaignName =
                                                                                    extractCampaignName(conversion);
                                                                                return campaignName ? (
                                                                                    <p className="text-sm">
                                                                                        {campaignName}
                                                                                    </p>
