...
const CustomerAnalyticsPage = () => {
    ...
    const { customers, meta, loading, error, fetchCustomerAnalytics } = useCustomerAnalytics({});
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {meta
                                ? `Showing ${customers.length} of ${meta.totalElements} on page`
            ...
            {loading ? (
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Customer performance and conversion history ({customers.length} customers)
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
