                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant={getServiceType(service.item_data?.name) === 'O' ? 'default' : 'secondary'}>
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <div className="flex items-center gap-1">
                              ...
                              {formatDuration(service.item_data?.variations?.[0]?.item_variation_data?.service_duration)}
                            </div>
                            <div className="flex items-center gap-1">
                              <DollarSign className="w-4 h-4" />
                              {formatPrice(service.item_data?.variations?.[0]?.item_variation_data?.price_money)}
                            </div>
                            <div className="flex items-center gap-1">
