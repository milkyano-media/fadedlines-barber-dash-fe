 ...
 */
const ServiceAssignmentInfoModal = ({ isOpen, onClose, barberName, barberSquareId }) => {
            ...
            <Card className="w-full max-w-2xl">
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-4">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            ...
                            <p className="text-sm text-blue-700 dark:text-blue-500 mb-3">
                                Due to Square API limitations, you need to manually assign the permissions and created
                                services to this team member through Square's dashboard.
                            </p>
                            <ol className="text-sm text-blue-700 dark:text-blue-500 space-y-2 ml-4 list-decimal">
                                <li>Click "Open Square Dashboard" below</li>
                                <li>
                                    In the 'Overview' tab, click <strong>"Finish Setup"</strong> to add permissions
                                </li>
                                <li>
                                    Then navigate to 'Appointments' tab, Click <strong>"Add to Appointments"</strong>
                                </li>
                                <li>
                                    Toogle on the 'Bookable by customers online' and assign the Services bookable online
                                </li>
                                <li>
                                    Click 'edit' the <strong>Services bookable online</strong> and select the created
                                    services
                                </li>
                                <li>
                                    Click 'edit' the <strong>Online booking profile</strong> and Setup the Online
                                    booking profile, also put the barber's instagram in the name as IG@username
                                </li>
                    ...
                    <div className="flex gap-3 justify-end pt-2">
                        ...
                        <Button onClick={handleOpenSquare} className="flex items-center gap-2">
