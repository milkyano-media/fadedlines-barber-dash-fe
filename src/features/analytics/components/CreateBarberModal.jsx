...
import { X, User, Briefcase, Scissors, Check, Plus, Trash2, ArrowRight, ArrowLeft } from "lucide-react";
            ...
            case "phoneNumber":
                if (value.trim()) {
                    ...
                    const phoneExists = existingMembers.some(
                        (member) => member.phoneNumber && member.phoneNumber === value,
                    );
                    if (phoneExists) {
        ...
        try {
            ...
            const barberData = {
                ...
                employmentDetails: {
                    ...
                    chairRentalRate:
                        formData.employmentType === "CHAIR_RENTAL" ? parseFloat(formData.chairRentalRate) : null,
                    ...
                    {currentStep === 1 && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {validationErrors.instagramHandle ? (
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                        This will be used for the category name: "{formData.givenName} [IG@
                                        {formData.instagramHandle || "handle"}]"
                                    </p>
                                )}
                            </div>
                            ...
                            <div>
                                    ...
                                    <div className="space-y-3 max-h-96 overflow-y-auto border rounded-md p-3">
                                        {availableJobs.length > 0 ? (
                                            availableJobs.map((job) => {
                                                const assignment = formData.jobAssignments.find(
                                                    (a) => a.job_id === job.id,
                                                );
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) => {
                                                                    if (e.target.checked) {
                                                                        ...
                                                                        handleInputChange(
                                                                            "jobAssignments",
                                                                            formData.jobAssignments.filter(
                                                                                (a) => a.job_id !== job.id,
                                                                            ),
                                                                        );
                                                                    }
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Assign jobs/roles with wage information. This is optional and can be configured
                                    later.
                                </p>
                            </div>
                        </div>
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <div className="grid grid-cols-1 gap-4">
                                                <div>
                                                    ...
                                                    />
                                                    <p className="text-xs text-muted-foreground mt-1">
                                                        "By {formData.givenName}" will be automatically added to the
                                                        service name
                                                    </p>
                                                </div>
                    ...
                    <div className="flex justify-between pt-4">
                        ...
                        {currentStep < 3 ? (
                            ...
                            <Button
                                ...
                                className="flex items-center gap-2"
                            >
                                {loading ? <LoadingSpinner size="small" /> : <Check className="w-4 h-4" />}
