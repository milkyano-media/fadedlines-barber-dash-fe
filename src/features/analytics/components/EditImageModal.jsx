...
const EditImageModal = ({ isOpen, onClose, onSuccess, teamService, barber }) => {
    ...
    const currentImageUrl = barber.details?.profileImageUrl ? `${API_BASE_URL}${barber.details.profileImageUrl}` : null;
            ...
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-2 pt-4">
                        <Button onClick={handleUpload} disabled={loading || !selectedImage} className="flex-1">
                            {loading ? (
                                <>
                                    <LoadingSpinner />
                        ...
                        {currentImageUrl && (
                            <Button onClick={handleDelete} disabled={loading} variant="destructive">
                                {loading ? <LoadingSpinner /> : <Trash2 className="w-4 h-4" />}
                            </Button>
                        )}
