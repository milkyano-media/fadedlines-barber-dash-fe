...
const BarberAnalyticsSummary = () => {
    ...
    const { barbers, meta, loading, error, fetchBarberAnalytics } = useBarberAnalytics({});
    ...
    }, [currentPage, deferredSearchTerm, sortBy, sortDir, dateRange, employmentType, fetchBarberAnalytics]);
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{summaryStats.totalBarbers}</div>
                        <p className="text-xs text-muted-foreground">
                            {meta ? `Showing ${barbers.length} of ${meta.totalElements} on page` : "All active barbers"}
                        </p>
                    </CardContent>
                </Card>
                <Card>
                ...
                <Card>
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium">Total Repeat Orders</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">{summaryStats.totalRepeatOrders || 0}</div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 justify-between">
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    >
                        <option value="default_desc">Default (Employment → Conversions → Order)</option>
                        <option value="displayOrder_asc">Sort by Display Order</option>
            ...
            {loading ? (
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Barber performance and conversion history ({barbers.length} barbers)
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <BarberAnalyticsList
