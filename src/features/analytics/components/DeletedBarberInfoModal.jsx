 ...
 */
const DeletedBarberInfoModal = ({ isOpen, onClose, barberName, barberSquareId }) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                            ...
                            <p className="text-sm text-orange-700 dark:text-orange-500 mb-3">
                                Due to Square API limitations, the team member has been <strong>deactivated</strong> but
                                not fully removed from Square. You need to manually remove them from the Appointments
                                list.
                            </p>
                            <ol className="text-sm text-orange-700 dark:text-orange-500 space-y-2 ml-4 list-decimal">
                                ...
                                <li>
                                    Navigate to the <strong>'Appointments'</strong> tab
                                </li>
                                <li>
                                    In the 'Bookable by customers online' section, click <strong>'Edit'</strong>
                                </li>
                                <li>
                                    Find <strong>{barberName}</strong> in the team members list
                                </li>
                            ...
                            <p className="text-xs text-orange-600 dark:text-orange-400 mt-3 font-medium">
                                💡 Note: The team member will remain in Square as "Inactive" but won't be bookable
                                online.
                            </p>
                        </div>
