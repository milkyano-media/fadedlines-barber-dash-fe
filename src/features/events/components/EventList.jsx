...
import { ChevronDown, ChevronUp, Calendar, Activity, Trash2, Link, ExternalLink, Copy, Check } from "lucide-react";
...
const EventList = ({
    ...
    const getEventSource = (event) => {
        ...
        if (event.properties?.non_web === true || event.properties?.booking?.source === "non-web") {
            return "non-web";
        }
    ...
    if (!events || events.length === 0) {
        return <div className="text-center py-8 text-muted-foreground">No events found matching your criteria.</div>;
    }
                                    ...
                                    {events.map((event) => (
                                        <React.Fragment key={event.id}>
                                            ...
                                            >
                                                ...
                                                {/* ID Column */}
                                                <td className="p-4 align-middle font-mono text-xs">{event.id}</td>
