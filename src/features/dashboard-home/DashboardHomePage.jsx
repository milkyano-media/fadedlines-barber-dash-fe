    ...
    if (error && !summary.totalConversions) {
        return (
            <div className="space-y-6">
                ...
                <ErrorMessage message={error.message || "Failed to load dashboard data"} onRetry={handleRefresh} />
            </div>
        );
    }
        ...
        <div className="space-y-6">
                    ...
                    <CardContent>
                        {loading ? (
                            ...
                            <>
                                ...
                                <p className="text-xs text-muted-foreground">Bookings converted from marketing</p>
                            </>
                        )}
                    </CardContent>
                </Card>
                                                ...
                                                >
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-muted-foreground">
                                                                {customer.totalConversions} booking
                                                                {customer.totalConversions > 1 ? "s" : ""}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="text-right">
                                                ...
                                                >
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-muted-foreground">
                                                                {barber.totalConversions} conversion
                                                                {barber.totalConversions > 1 ? "s" : ""}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="text-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <Link to="/barbers">
                            <Button className="w-full">View Barber Analytics</Button>
                        </Link>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Link to="/campaigns">
                            <Button className="w-full">View Campaign Analytics</Button>
                        </Link>
                    </CardContent>
                </Card>
