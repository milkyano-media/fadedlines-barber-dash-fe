...
const CampaignList = ({ campaigns }) => {
    ...
    if (!campaigns || campaigns.length === 0) {
        return <div className="text-center py-8 text-muted-foreground">No campaigns found.</div>;
    }
                            ...
                            <table className="w-full min-w-[640px] caption-bottom text-sm">
                                <thead className="[&_tr]:border-b">
                                    <tr className="border-b transition-colors hover:bg-muted/50">
                                        <th className="h-10 px-4 text-left align-middle font-medium">Campaign Name</th>
                                        <th className="h-10 px-4 text-center align-middle font-medium">Conversions</th>
                                        <th className="h-10 px-4 text-center align-middle font-medium">Revenue</th>
                                        <th className="h-10 px-4 text-center align-middle font-medium">Avg. Value</th>
                                        <th className="h-10 px-4 text-center align-middle font-medium w-24">Actions</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr className="border-b transition-colors hover:bg-muted/50 cursor-pointer">
                                                ...
                                                <td className="p-4 align-middle text-center">
                                                    <span className="font-medium">
                                                        ${campaign.avgConversionValue.toFixed(2)}
                                                    </span>
                                                </td>
                                                <td className="p-4 align-middle text-center">
                                                    <button
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className="text-right">
                                                                                <p className="font-bold">
                                                                                    $
                                                                                    {Number(conversion.amount).toFixed(
                                                                                        2,
                                                                                    )}
                                                                                </p>
                                                                                <p className="text-xs text-muted-foreground">
