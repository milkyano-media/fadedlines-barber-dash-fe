    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const showErrorToast = (message) => {
                ...
                toastDiv.className =
                    "login-error-toast fixed bottom-4 right-4 z-50 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-400 rounded-lg shadow-lg p-3 flex items-center justify-between min-w-[300px] max-w-[500px] animate-in fade-in slide-in-from-bottom-5 duration-300";
